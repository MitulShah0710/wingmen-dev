...
var bookingModelSchema = new Schema({
  ...
  firstName: { type: String, ref: 'firstName'},
  lastName: { type: String, ref: 'lastName'},
  phoneNo: { type: Number, ref: 'phoneNo'},
  countryCode: { type: Number, ref: 'countryCode'},
...
bookingModelSchema.plugin(autoIncrement.plugin, {
  model: 'Booking',
  field: 'bookingNo',
  startAt: 1000,
  incrementBy: 1
...
bookingModelSchema.index({ cordinates: "2dsphere" });
bookingModelSchema.index({ pickUpLocation: "2dsphere" });
bookingModelSchema.index({ droupUpLocation: "2dsphere" });
bookingModelSchema.index({ droupUpLocationFirst: "2dsphere" });
bookingModelSchema.index({ droupUpLocationSecond: "2dsphere" });
bookingModelSchema.index({ droupUpLocationThird: "2dsphere" });
bookingModelSchema.index({ droupUpLocationFour: "2dsphere" });
